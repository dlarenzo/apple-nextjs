...
const Square5 = () => {
  return (
    <div className="w-full h-[600px] bg-[url('/images/promo_apple_card__6square_large_2x.jpeg')] bg-cover bg-center relative">
      <div class="w-full pt-10 flex justify-center">
        <div class="py-2 text-center text-black">
          ...
          <h3 class=" text-lg sm:text-lg md:text-xl lg:text-2xl ">
            Get up ot 3% Daily Cash back <br /> with every purchase.
          </h3>
