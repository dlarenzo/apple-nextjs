...
const Square6 = () => {
  return (
    <div className="w-full h-[600px] bg-[url('/images/promo_iphone_tradein__6square_large_2x.jpeg')] bg-cover bg-center relative">
      <div class="w-full pt-10 flex justify-center">
        <div class="py-2 text-center text-black">
          ...
          <h3 class=" text-lg sm:text-lg md:text-xl lg:text-2xl ">
            Get $170-$630 in credit when you <br /> trade in your iPhone 11 or
            higher
          </h3>
